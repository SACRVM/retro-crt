...
public enum TypewriterCursor : byte
{
    ...
    /// <summary>Half-block cursor (<c>▌</c> or <c>|</c> on ASCII).</summary>
    Block = 1,
    ...
    /// <summary>
    /// Full solid block (<c>█</c> or <c>#</c> on ASCII). The chunky
    /// "Wake up, Neo" cursor — pair with <see cref="Typewriter.Blink"/>
    /// for the full pause-and-blink Matrix vibe between phrases.
    /// </summary>
    MatrixBlock = 3,
}
